...
page import="com.liferay.asset.kernel.exception.DuplicateAssetCategoryExternalReferenceCodeException" %><%@
page import="com.liferay.asset.kernel.exception.DuplicateAssetVocabularyExternalReferenceCodeException" %><%@
