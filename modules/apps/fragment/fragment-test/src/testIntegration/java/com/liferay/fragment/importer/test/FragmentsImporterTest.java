...
public class FragmentsImporterTest {
	...
	public void testImportFragmentResourcesCreatesNewResourceWithoutPropagation()
		...
		_testResources(2, "src=\"[resources:image (1).png]\"");
	}
	...
	public void testImportFragmentResourcesCreatesNoNewResourceWithPropagation()
		...
		try {
			_testResources(1, "src=\"[resources:image.png]\"");
		}
		finally {
			_configurationProvider.saveCompanyConfiguration(
				FragmentServiceConfiguration.class, _group.getCompanyId(),
	...
	private void _testResources(int resourceNumber, String resourceReference)
		throws Exception {
		...
		Assert.assertEquals(
			resources.toString(), resourceNumber, resources.size());
